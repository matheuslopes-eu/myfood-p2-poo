...
/**
 * A classe Sistema representa o núcleo do sistema de gerenciamento de pedidos.
 * Ela lida com operações relacionadas a usuários, restaurantes, produtos e pedidos,
 * e gerencia o estado persistente desses dados.
 */
public class Sistema {
    ...
    /**
     * Construtor que inicializa o sistema carregando dados persistentes.
     *
     * @throws IOException Se ocorrer um erro durante a leitura dos dados persistentes.
     * @throws ClassNotFoundException Se a classe dos dados persistentes não for encontrada.
     */
